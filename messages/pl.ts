...
export default JSON.parse(`{
  ...
  "error": {
    ...
    "pity": "Niestety, wystąpił błąd."
  },
  "auth": {
  "email": {
    "title": "E-mail",
    "description": "To jest twój adres e-mail"
  },
  "password": {
    "title": "Hasło",
  ...
  "signup": {
    ...
    "login": {
      "question": "Masz już konto? Zaloguj się tutaj",
      "linkText": "Zaloguj się tutaj"
    }
  },
  "login": {
